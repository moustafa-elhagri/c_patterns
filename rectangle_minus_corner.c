 ...
 * @brief        : Print a hollow rectangle of asterisks
...
int main(void)
{
    ...
    printf("\nThere goes your (%ux%u) asterisk rectangle!\n\n", rows, columns);
    ...
    for(row_iterator = 0; row_iterator < rows; row_iterator++)
    {
        ...
        {
            if(((row_iterator == 0) || (row_iterator == rows - 1)) && ((column_iterator == 0) || (column_iterator == rows - 1)))
            {
            printf("  ");
            }
            else
